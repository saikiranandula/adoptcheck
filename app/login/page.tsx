...
const authErrorCopy: Record<string, string> = {
  ...
  invalid_provider: "That sign-in option is not available.",
};
    ...
    >
      <div style={card}>
        <div style={{ textAlign: "center", display: "flex", flexDirection: "column", gap: 8 }}>
          ...
          <h1 style={{ fontSize: 24, fontWeight: 600, color: "var(--text)" }}>Sign in to continue</h1>
          <p style={{ fontSize: 14, color: "var(--muted)" }}>
            Your free checks need no account. Sign in to buy and keep credits across devices.
          </p>
        </div>
        ...
        >
          <Link href={githubHref} style={btn}>
          ...
          <Link href={googleHref} style={btn}>
          ...
          <p style={{ fontSize: 11, color: "var(--muted)", textAlign: "center", marginTop: 2 }}>
        ...
        <p style={{ textAlign: "center", fontSize: 12, color: "var(--muted)" }}>
          <Link href="/" style={{ color: "var(--soft)" }}>
            &larr; Back to AdoptCheck
          </Link>
        </p>
      </div>
    </main>
